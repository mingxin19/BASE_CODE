    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                """),format.raw/*63.17*/("""<div class="log">
                <li """),_display_(/*64.22*/if(title=="Login")/*64.40*/{_display_(Seq[Any](format.raw/*64.41*/("""class="active"""")))}),format.raw/*64.56*/(""">
